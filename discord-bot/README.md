...
This sample demonstrates using Mongoose to build a sample [Discord](https://discord.com) bot.

## Setup

Make sure you have MongoDB running locally, or update your `.env` to point to your Atlas cluster.
